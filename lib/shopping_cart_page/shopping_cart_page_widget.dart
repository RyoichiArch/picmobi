  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ShoppingcartRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ShoppingcartRecord> shoppingCartPageShoppingcartRecordList =
            snapshot.data!;
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          10.0, 0.0, 0.0, 0.0),
                                                  child: Text(
                                                    '${columnShoppingcartRecord.amount.toString()}個',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
