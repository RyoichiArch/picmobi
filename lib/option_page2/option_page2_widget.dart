...
import 'option_page2_model.dart';
export 'option_page2_model.dart';

class OptionPage2Widget extends StatefulWidget {
  const OptionPage2Widget({
    Key? key,
    String? buyplace,
    String? buyplace2,
    String? buyplace3,
  ...
  @override
  _OptionPage2WidgetState createState() => _OptionPage2WidgetState();
}

class _OptionPage2WidgetState extends State<OptionPage2Widget> {
  late OptionPage2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OptionPage2Model());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ShoppingcartRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ShoppingcartRecord> optionPage2ShoppingcartRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final optionPage2ShoppingcartRecord =
            optionPage2ShoppingcartRecordList.isNotEmpty
                ? optionPage2ShoppingcartRecordList.first
                : null;
